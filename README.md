...
- 📍 [Geometrien der Wahllokale fur die Wahl zum 20. Abgeordnetenhaus von Berlin und BVV 2026](https://daten.berlin.de/datensaetze/geometrien-der-wahllokale-fur-die-wahl-zum-20-abgeordnetenhaus-von-berlin-und-bvv-2026) - Berlin Open Data dataset from Amt fur Statistik Berlin-Brandenburg, published on 7 August 2026, with point geometries and full addresses of the polling stations; 4,114 records covering 2,542 Urnenwahl and 1,572 Briefwahl districts, in ETRS89 / UTM 33N with WGS84 coordinates and an accessibility flag included, licensed CC BY 3.0 DE.
